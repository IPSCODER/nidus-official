...
const DataAnalyst = () => {
  ...
  <LandingPage title="Introduction" firstTitle='Data Analytics' secondTitle='& AI' description="At Nidus Technologies, we unlock the potential of data through powerful analytics, ML engineering, and AI-driven insights. Our solutions help businesses make smarter decisions, forecast outcomes, and operate with precision across departments." imageUrl="https://images.pexels.com/photos/6476783/pexels-photo-6476783.jpeg" />
