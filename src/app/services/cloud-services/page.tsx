...
<LandingPage title="Introduction" firstTitle="Cloud" secondTitle="Services" description="At Nidus Technologies, we architect and implement cloud-native solutions that drive business agility, scalability, and cost optimization. Whether youre migrating from legacy systems or building modern microservices, our cloud engineering team delivers secure, scalable, and future-ready infrastructure on AWS, Azure, or GCP." imageUrl="https://images.pexels.com/photos/17489155/pexels-photo-17489155.jpeg" />
