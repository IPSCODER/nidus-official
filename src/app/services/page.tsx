  ...
  return (
    <>
      <LandingPage title="Our Technology Consulting Services" description="We offer a comprehensive suite of consulting services tailored to your unique business needs.
          ...
          in today’s competitive environment." firstTitle="Services" imageUrl="https://images.pexels.com/photos/17402495/pexels-photo-17402495.jpeg" />
            <div className="mx-auto px-2 md:px-5 my-5">
        {/* Industries Grid */}
     <FeatureGrid points={servicesFeaturedGrid} sectionTitle="Services" highlight="" />
      </div>
      <NidusTransition
