...
<p className='w-4xl text-gray-400 text-center' >At Nidus, we empower businesses with innovative technology solutions to thrive in the digital age. Our passion for technology, combined with our commitment to excellence, enables us to deliver tailored solutions that drive success.</p>
    </div>
<div className='relative z-10 bg-black/40' >
<Image src='https://images.pexels.com/photos/16676908/pexels-photo-16676908.jpeg' width={1000} height={1000} alt='hero-image' className='w-full h-[60vh] object-cover rounded-md my-10 ' />    
</div>
  </div>
    </>
  )
